...
def smoothing(cubeviz_layout):
    ...
    sm = SelectSmoothing(cl._data, parent=cl, allow_preview=True)
...
def test_smoothing_preview(qtbot, cubeviz_layout):
    # Create GUI
    ...
    qtbot.mouseClick(sm.previewButton, QtCore.Qt.LeftButton)
